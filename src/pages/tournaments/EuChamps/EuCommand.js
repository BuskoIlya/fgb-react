          ...
          data.map((item) =>
            <tr key={item.year}>
              ...
              <td data-label="Золото" className="table__cell">
                <TitleCountry flagImg={flagPath + item.g_flag} text={item.g_country} />
              </td>
              <td data-label="Серебро" className="table__cell">
                <TitleCountry flagImg={flagPath + item.s_flag} text={item.s_country} />
              </td>
              <td data-label="Бронза" className="table__cell">
                <TitleCountry flagImg={flagPath + item.b_flag} text={item.b_country} />
              </td>
            </tr>
          )
        }
